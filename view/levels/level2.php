...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validate["success"]) {
        ...
        $view->success("Level 2", "You did it!");
    } else {
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Game Level 2</h1>
    ...
    <div class="card-body">
        <form method="post" action="level2.php">
            <div class="row">
                ...
                <div class="col-md-4">
                    <?php if ($gameInfo["level"] > 2): ?>
                        <a href="level2.php" class="btn btn-secondary">
                ...
                <div class="col-md-4">
                    <?php if ($gameInfo["level"] > 2): ?>
                        <a href="level3.php" class="btn btn-success">
                            Go the Next Level
                        </a>
                    <?php endif; ?>
                </div>
