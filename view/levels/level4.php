...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validate["success"]) {
        ...
        $view->success("Level 4", "You did it!");
    } else {
...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Game Level 4</h1>
    ...
    <div class="card-body">
        <form method="post" action="level4.php">
            <div class="row">
                ...
                <div class="col-md-4">
                    <?php if ($gameInfo["level"] > 4): ?>
                        <a href="level4.php" class="btn btn-secondary">
                ...
                <div class="col-md-4">
                    <?php if ($gameInfo["level"] > 4): ?>
                        <a href="level5.php" class="btn btn-success">
                            Go the Next Level
                        </a>
                    <?php endif; ?>
                </div>
